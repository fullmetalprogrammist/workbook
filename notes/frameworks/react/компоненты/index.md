...
- Функциональный компонент
  - Современно, с хуками
  - Синтаксис
    - [Function Declaration](оформление-компонента-react#function-declaration)
    - [Лямбда (это частный случай Function Expression)](оформление-компонента-react#лямбда)
- Классовый
  - легаси
...
- способы экспорта (и правила импорта)
  - [дефолтный экспорт](оформление-компонента-react#дефолтный-экспорт)
    - синтаксис
  ...
  - [обычный экспорт](оформление-компонента-react#обычный-экспорт) ("именованный")
    - синтаксис
      - одной строкой: объявление компонента + экспорт
      - отдельно объявление, отдельно экспорт
    - импорт
...
- Пропсы бывают
  - ["Наши пропсы"](пропсы#наши-пропсы)
    - произвольные атрибуты, которые мы сами передаем в компонент
  - [Стандартные пропсы](пропсы#стандартные-пропсы)
    - children
...
- [Проброс пропсов](пропсы#проброс-пропсов) в дочерний компонент `{...props}`
...
- [Ключевое отличие управляемого от неуправляемого компонента](управляемый-и-неуправляемый-компонент-react#управляемый-vs-неуправляемый-компонент)
...
- Реализация
  - ⚡[Управляемый компонент](управляемый-и-неуправляемый-компонент-react#управляемый-компонент)
    - через useState
    - в change-обработчиках элементов вызываем функии изменения состояния
  - ⚡[Неуправляемый компонент](управляемый-и-неуправляемый-компонент-react#неуправляемый-компонент)
    - через useRef
    ...
    - тонкости
      - [Проброс ref](управляемый-и-неуправляемый-компонент-react#явный-проброс-ref) в самописный компонент
...
- Примеры пользы уникальности
  - [Списки однотипных элементов (товары, пользователи)](уникальность-компонента-react#списки-элементов)
