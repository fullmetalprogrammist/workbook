...
- ⭐ [Корневой редюсер (root reducer)](базовые-концепции#корневой-редюсер)
  ...
  - Redux использует его, чтобы инициализировать состояние
    - Как это происходит
  ...
  - В Redux и RTK настраивается по-разному

## Хранилище

- ⭐ Хранилище (store)
  - Компонент, в который мы оборачиваем приложение, и за счет контекста состояние становится доступно всем компонентам приложения
  - Начальная настройка
...
- ⭐ Слайс (slice)
  ...
  - Смысл слайса
    - Упростить рутинные вещи
      ...
      - Соберет редюсеры, которые мы в нем описали, в один общий и настроит его на обработку действий

## Флоу работы с хранилищем
